...
from space_map_data.download.providers.objects.astersat import AsterSatDownloader
from space_map_data.download.providers.objects.johnston import JohnstonDownloader
