...
CONSTELLATIONS: tuple[ConstellationSpec, ...] = (
    ...
    ConstellationSpec("orbcomm", "Orbcomm", "Q16960684", prefix="ORBCOMM"),
    ...
    ConstellationSpec("gonets", "Gonets", "Q2041033", prefix="GONETS-M"),
    ...
    ConstellationSpec("spire", "Spire Lemur", "Q19877982", group="spire"),
    ConstellationSpec("intelsat", "Intelsat", "Q778126", group="intelsat"),
    ConstellationSpec("ses", "SES", "Q333025", group="ses"),
    ConstellationSpec("eutelsat", "Eutelsat", "Q848336", group="eutelsat"),
