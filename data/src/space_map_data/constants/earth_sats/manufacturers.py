...
MANUFACTURERS: tuple[ManufacturerSpec, ...] = (
    ...
    ManufacturerSpec("Sierra Nevada Corporation", "sierra-nevada", "Q3483455"),
    # Added for the GCAT manufacturer join; see gcat_orgs.py.
    ManufacturerSpec("Applied Physics Laboratory", "apl", "Q249373"),
    ManufacturerSpec("Blue Canyon Technologies", "blue-canyon", "Q30297807"),
    ManufacturerSpec("Fairchild Space and Defense Systems", "fairchild", "Q117113792"),
    ManufacturerSpec("Ford Aerospace", "ford-aerospace", "Q4353824"),
    ManufacturerSpec("Kometa", "kometa", "Q24930315"),
    ManufacturerSpec("Matra Marconi Space", "matra", "Q6787769"),
    ManufacturerSpec("United States Naval Research Laboratory", "nrl", "Q1499258"),
    ManufacturerSpec("Satellogic", "satellogic", "Q22669551"),
    ManufacturerSpec("Shanghai Academy of Spaceflight Technology", "sast", "Q17018970"),
    ManufacturerSpec("Spectrum Astro", "spectrum-astro", "Q85802558"),
    ManufacturerSpec("SPUTNIX", "sputnix", "Q65146667"),
    ManufacturerSpec("Surrey Satellite Technology", "sstl", "Q457987"),
    ManufacturerSpec("Progress Rocket Space Centre", "tsskb-progress", "Q136426"),
    ManufacturerSpec("UTIAS Space Flight Laboratory", "utias-sfl", "Q123357952"),
    ManufacturerSpec("Yuzhnoye Design Bureau", "yuzhnoye", "Q618898"),
    ManufacturerSpec(
        "All-Russian Scientific Research Institute of Electromechanics",
        "vniiem",
        "Q4479911",
    ),
    ManufacturerSpec("Jet Propulsion Laboratory", "jpl", "Q189325"),
    ManufacturerSpec("Tyvak Nano-Satellite Systems", "tyvak", "Q22078253"),
    ManufacturerSpec("Motorola", "motorola", "Q259011"),
    ManufacturerSpec("GomSpace", "gomspace", "Q31898574"),
    ManufacturerSpec("Kongsberg NanoAvionics", "nanoavionics", "Q25499051"),
    ManufacturerSpec("Entwicklungsring Nord", "erno", "Q322498"),
    ManufacturerSpec("U. R. Rao Satellite Centre", "ursc", "Q3520778"),
    ManufacturerSpec("Kuiper Systems", "kuiper-systems", "Q98140562"),
    ManufacturerSpec("Innovation Academy for Microsatellites", "secm", "Q55697625"),
