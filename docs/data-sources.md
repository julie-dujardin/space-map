...
| Cospar ID | Artificial satellite, few Probes | 1990-037B, 2003-027A | https://web.archive.org/web/2024/https://nssdc.gsfc.nasa.gov/nmc/spacecraft/display.action?id=\<id\> (NSSDCA itself is offline; the Wayback copy only covers ids that were crawled), https://www.n2yo.com/database/?q=\<id\> | | P247 | Celestrak, horizons |
