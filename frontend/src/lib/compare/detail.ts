 ...
 * it, so the position stands at the origin and says so.
 */
...
/** The drawer's body variant — the only shape this page ever focuses. */
export type CompareFocus = Extract<Focusable, { kind: 'body' }>;
