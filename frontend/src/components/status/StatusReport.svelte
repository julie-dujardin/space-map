<!--
  The status table itself: one row per source, grouped by what it feeds. The
			...
			<ul>
				{#each section.sources as source (source.id)}
					<li class="flex items-baseline gap-4 border-b border-border py-2.5">
						...
						<div class="hidden w-28 shrink-0 text-end text-muted-foreground tabular-nums sm:block">
